...
def test_right_way(browser):
    ...
    common_helper.enter_input(input_id="billing_first_name", data="Maxim")
    common_helper.enter_input(input_id="billing_last_name", data="Kulagin")
    common_helper.enter_input(input_id="billing_address_1", data="31, Gagarinsky Lane")
    common_helper.enter_input(input_id="billing_city", data="Moscow")
    common_helper.enter_input(input_id="billing_state", data="Moscow")
    common_helper.enter_input(input_id="billing_postcode", data="119034")
    common_helper.enter_input(input_id="billing_phone", data="+79625449802")
    common_helper.enter_input(input_id="billing_email", data="max.kulaginc@gmail.com")
